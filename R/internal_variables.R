...
getStoppagesWhitelist <- c(
  ...
  "stoppages.periodSeconds", "stoppages.graphical.x", "stoppages.graphical.y",
  "stoppages.graphical.standardX", "stoppages.graphical.standardY",
  ...
  "stoppages.attendance.players", "stoppages.hitout.id", "stoppages.hitout.name",
  ...
  "stoppages.hitout.player.playerId", "stoppages.hitout.player.squadId",
  ...
  "stoppages.firstPossession.player.playerId", "stoppages.firstPossession.player.squadId",
  ...
  "stoppages.clearance.player.playerId", "stoppages.clearance.player.squadId",
  ...
  "stoppages.stoppageExit.stoppageExitType", "stoppages.stoppageExit.pressure",
  "stoppages.stoppageExit.player.displayName", "stoppages.stoppageExit.player.fullName",
  "stoppages.stoppageExit.player.playerId", "stoppages.stoppageExit.player.squadId",
  ...
  "stoppages.stoppageExit.graphical.x", "stoppages.stoppageExit.graphical.y",
  "stoppages.stoppageExit.graphical.standardX", "stoppages.stoppageExit.graphical.standardY"
)
...
getStoppagesExposedFields <- c(
  ...
  attendance.period                         = "stoppages.attendance.period",
  attendance.period.seconds                 = "stoppages.attendance.periodSeconds",
  attendance.players                        = "stoppages.attendance.players",
  stoppage.graphical.x                      = "stoppages.graphical.x",
  stoppage.graphical.y                      = "stoppages.graphical.y",
  stoppage.graphical.standard.x             = "stoppages.graphical.standardX",
  stoppage.graphical.standard.y             = "stoppages.graphical.standardY",
  hitout.id                                 = "stoppages.hitout.id",
  hitout.name                               = "stoppages.hitout.name",
  hitout.code                               = "stoppages.hitout.code",
  hitout.period                             = "stoppages.hitout.period",
  hitout.period.seconds                     = "stoppages.hitout.periodSeconds",
  hitout.player.display.name                = "stoppages.hitout.player.displayName",
  hitout.player.full.name                   = "stoppages.hitout.player.fullName",
  hitout.player.id                          = "stoppages.hitout.player.playerId",
  ...
  first.possession.period                   = "stoppages.firstPossession.period",
  ...
  first.possession.player.display.name      = "stoppages.firstPossession.player.displayName",
  first.possession.player.full.name         = "stoppages.firstPossession.player.fullName",
  first.possession.player.id                = "stoppages.firstPossession.player.playerId",
  ...
  clearance.period                          = "stoppages.clearance.period",
  clearance.period.seconds                  = "stoppages.clearance.periodSeconds",
  clearance.zone                            = "stoppages.clearance.zone",
  clearance.player.display.name             = "stoppages.clearance.player.displayName",
  clearance.player.full.name                = "stoppages.clearance.player.fullName",
  clearance.player.id                       = "stoppages.clearance.player.playerId",
  ...
  exit.period                               = "stoppages.stoppageExit.period",
  exit.period.seconds                       = "stoppages.stoppageExit.periodSeconds",
  exit.zone                                 = "stoppages.stoppageExit.zone",
  exit.type                                 = "stoppages.stoppageExit.stoppageExitType",
  exit.pressure                             = "stoppages.stoppageExit.pressure",
  exit.player.display.name                  = "stoppages.stoppageExit.player.displayName",
  exit.player.full.name                     = "stoppages.stoppageExit.player.fullName",
  exit.player.id                            = "stoppages.stoppageExit.player.playerId",
  ...
  exit.graphical.x                          = "stoppages.stoppageExit.graphical.x",
  exit.graphical.y                          = "stoppages.stoppageExit.graphical.y",
  exit.graphical.standard.x                 = "stoppages.stoppageExit.graphical.standardX",
  exit.graphical.standard.y                 = "stoppages.stoppageExit.graphical.standardY"
)
